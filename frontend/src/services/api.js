...
api.interceptors.request.use(
    (config) => {
        ...
        // getToken() comes from auth.js. gets the current access token of the user
        // to add to the head of request under Authorization: Bearer <token>
